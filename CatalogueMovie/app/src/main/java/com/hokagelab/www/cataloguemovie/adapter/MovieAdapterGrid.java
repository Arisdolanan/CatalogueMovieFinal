...
public class MovieAdapterGrid extends RecyclerView.Adapter<MovieAdapterGrid.ViewHolder>{
    ...
    public MovieAdapterGrid(List <Result> MovieList){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View mView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_coming, parent, false);
...
//        holder.tv_title.setText(mMovieList.get(position).getTitle());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            imagePoster = itemView.findViewById(R.id.imagePosteran);
        }
    }
}
